...
<template>
    <div class="shadow border w-64 mr-10 z-30 h-[190px] relative">
        ...
        <div class="p-5 flex justify-between relative cursor-pointer border-b">
            ...
            <div v-if="modal.make" class="absolute border shadow left-56 p-5 top-1 w-[600px] flex justify-between flex-wrap bg-white">
        ...
        <div class="p-5 flex justify-between relative cursor-pointer border-b">
            ...
            <div v-if="modal.price" class="absolute border shadow left-56 p-5 top-1 w-[600px] flex justify-between flex-wrap bg-white">
